    ...
    <div className="flex flex-col min-h-screen bg-white">
      <div className="flex justify-center py-4">
        <div className="bg-home rounded-full w-76 h-14 md:w-76 md:h-16 flex items-center justify-center p-4">
          <h1 className="text-xl md:text-2xl font-bold text-white" onClick={() => handleCategoryExpansion(0)}>Data Market Categories</h1>
        </div>
      </div>
                ...
                <div className="flex flex-wrap items-center justify-between py-4 -m-2">
                  <div className="w-auto p-2">
                    <div className="flex flex-wrap items-center -m-2">
                      ...
                      <div className="w-auto p-2">
                        <h2 className="text-sm font-medium text-coolGray-900">Photos</h2>
                ...
                <div className="flex flex-wrap items-center justify-between py-4 -m-2">
                  <div className="w-auto p-2">
                    <div className="flex flex-wrap items-center -m-2">
                      ...
                      <div className="w-auto p-2">
                        <h2 className="text-sm font-medium text-coolGray-900">Folders</h2>
                ...
                <div className="flex flex-wrap items-center justify-between py-4 -m-2">
                  <div className="w-auto p-2">
                    <div className="flex flex-wrap items-center -m-2">
                      ...
                      <div className="w-auto p-2">
                        <h2 className="text-sm font-medium text-coolGray-900">Movies</h2>
